...
class ProductoController{
    ...
    public function gestionarProductos() {
        $productos = $this->productoService->recuperarTodasCategorias();
    ...
    public function crear() {
        ...
        $categorias = $this->productoService->recuperarTodasCategorias();
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $this->productoService->guardarCategoria($categoriaId, $nombre, $descripcion, $precio, $stock, $imagen);
    ...
    public function borrar($id) {
        $this->productoService->borrarCategoria($id);
    ...
    public function editar() {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $this->productoService->actualizarCategoria($id, $nombre, $descripcion, $precio, $categoriaId, $imagen);

            header('Location: ' . BASE_URL);
        } else {
            $id = $_GET['id'];
            $producto = $this->productoService->categoriaPorId($id);
